...
openshift-cluster.${DOMAIN}.  IN A ${IP_LB}
${HOST_LB}.       IN A ${IP_LB}
${HOST_MASTER1}.  IN A ${IP_MASTER1}
${HOST_MASTER2}.  IN A ${IP_MASTER2}
${HOST_MASTER3}.  IN A ${IP_MASTER3}
${HOST_REGISTRY1}.  IN A ${IP_REGISTRY1}
${HOST_REGISTRY2}.  IN A ${IP_REGISTRY2}
${HOST_REGISTRY3}.  IN A ${IP_REGISTRY3}
${HOST_NODE1}.  IN A ${IP_NODE1}
${HOST_NODE2}.  IN A ${IP_NODE2}
${HOST_NODE3}.  IN A ${IP_NODE3}
${HOST_NODE4}.  IN A ${IP_NODE4}
${HOST_NODE5}.  IN A ${IP_NODE5}
!
...
; PTR Records
${IP_LB_INV} IN        PTR     openshift-cluster.${DOMAIN}. 
${IP_MN_INV} IN        PTR     ${HOST_MN}. 
${IP_LB_INV} IN        PTR     ${HOST_LB}. 
${IP_MASTER1_INV} IN        PTR     ${HOST_MASTER1}.     
${IP_MASTER2_INV} IN        PTR     ${HOST_MASTER2}.     
${IP_MASTER3_INV} IN        PTR     ${HOST_MASTER3}.     
${IP_REGISTRY1_INV} IN        PTR     ${HOST_REGISTRY1}.     
${IP_REGISTRY2_INV} IN        PTR     ${HOST_REGISTRY2}.     
${IP_REGISTRY3_INV} IN        PTR     ${HOST_REGISTRY3}.     
${IP_NODE1_INV} IN        PTR     ${HOST_NODE1}.     
${IP_NODE2_INV} IN        PTR     ${HOST_NODE2}.     
${IP_NODE3_INV} IN        PTR     ${HOST_NODE3}.     
${IP_NODE4_INV} IN        PTR     ${HOST_NODE4}.     
${IP_NODE5_INV} IN        PTR     ${HOST_NODE5}.     
!
